...
import { AlertCircle, Award, CalendarDays, Clock, CreditCard, Loader, MapPin, Stethoscope, User, UserRound } from "lucide-react"
...
const BookAppointment = () => {
    ...
    const appointmentId = useLocation().search.split('=')[1]
    ...
    const { control, register, setValue, reset, watch, handleSubmit, formState: { errors } } = useForm<z.infer<typeof SCHEMA>>({
    ...
    const { mutate: createAppointment, isPending: isPendingCreateAppointment } = useMutation({
        mutationFn: (formData: any) => AppointmentApi.createAppointment(formData),
    ...
    const { mutate: updateAppointment, isPending: isPendingUpdateAppointment } = useMutation({
        mutationFn: (formData: any) => AppointmentApi.updateAppointment(appointmentId!, formData),
        onSuccess: ({ message }: { message: string }) => {
            toast.success(message)
            router(`/appointment`)
        }, onError: (err: AxiosError<{ message: string }>) => {
            ...
            <Card className="w-full max-w-7xl mx-auto shadow-2xl border-0 bg-white/90 dark:bg-gray-900/90 backdrop-blur-xl rounded-3xl overflow-hidden">
                ...
                <CardContent className="p-5">
                    <form className="space-y-8" onSubmit={handleSubmit((data) => {
                        appointmentId ? updateAppointment(data) : createAppointment(data)
                    })}>
                                ...
                                <div className="p-6 space-y-6">
                                            ...
                                            <div>
                                                ...
                                                <div className='flex gap-3'>
                                                    <div className="flex-1">
                                                        ...
                                                        {errors.patientId && <p className='text-sm text-red-500 mt-1 flex items-center gap-1'>
                                                            <AlertCircle className="h-4 w-4" />
                                                            {errors.patientId.message}
                                                        </p>}
                                                    </div>
                                                    <Button type='button' size='sm' className="bg-green-600 hover:bg-green-700" onClick={() => setForm(true)}>
                                    ...
                                    <div className="grid lg:grid-cols-2 gap-4">
                                            ...
                                            <>
                                                ...
                                                <div className="space-y-2">
                                                    <Controller control={control} name='status' render={({ field }) => (
                                                        <>
                                                            ...
                                                            <Select value={field.value || ''} onValueChange={(value) => { field.onChange(value) }} disabled={!!appointmentId}>
                                                                <SelectTrigger className="bg-gray-50 dark:bg-gray-700 border-gray-200 dark:border-gray-600">
                                                ...
                                                <div className="space-y-2">
                                                    ...
                                                    <Input
                                                        ...
                                                        placeholder="0"
                                                    />
                                                    {errors.discount && <p className='text-sm text-red-500 flex items-center gap-1'>
                                                        <AlertCircle className="h-4 w-4" />
                                                ...
                                                <div className="space-y-2">
                                                            ...
                                                            <Select value={field.value || ''} onValueChange={(value) => { field.onChange(value) }}>
                                                                ...
                                                                <SelectContent className='z-[200]'>
                                                                    {PaymentOptions.map((payment, i) => (
                                                                        <SelectItem key={i} value={payment.value}>
                                                                            <div className="flex items-center gap-2">
                                                    ...
                                                    {errors.payment_mode && <p className='text-sm text-red-500 flex items-center gap-1'>
                                                        <AlertCircle className="h-4 w-4" />
                                        ...
                                        <div className="col-span-full pt-4">
                                            ...
                                            >
                                                {(isPendingCreateAppointment || isPendingUpdateAppointment) ? (
                                                    <>
                                                    ...
                                                    <>
                                                        ...
                                                        {appointmentId ? 'Update' : 'Book'} Appointment
                                                    </>
                                                )}
                                            </Button>
                                        </div>
