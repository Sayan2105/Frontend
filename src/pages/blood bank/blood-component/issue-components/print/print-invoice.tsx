...
import { IssuedBloodComponentInfo } from '@/types/blood-bank/blood-bank';
...
type Props = {
    afterPrint: () => void,
    info: IssuedBloodComponentInfo
}


const PrintIssueBloodComponnetInvoice = ({ afterPrint, info }: Props) => {
    ...
    const headers = ['Blood Group', 'Component', 'Bag', 'Charge Name', `STD Charge ${currencySymbol()}`, `Total ${currencySymbol()}`]
                    ...
                    <Table>
                        ...
                        <TableBody>
                            <TableRow className="dark:border-gray-200">
                                ...
                                <TableCell className="py-3 text-sm">{info.component}</TableCell>
...
export default PrintIssueBloodComponnetInvoice
