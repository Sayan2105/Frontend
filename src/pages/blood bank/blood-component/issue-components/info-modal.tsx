...
interface IssueBloodComponentInfoModalProps extends HTMLAttributes<HTMLDivElement> {
        ...
        <Dialog pageTitle="Issued Component" {...props}>
            <ScrollArea className={'relative h-[65vh] sm:h-[60vh] w-full'}>
                ...
                <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-3 px-2.5 pb-14">
                    ...
                    <CardBox borderType='solid' title="Component" value={info?.component} />
...
export default IssueBloodComponentModal