...
const Documents = ({ details, report, collection, afterGenerate }: DocumentProps) => {
    ...
    return (
        <Backdrop onClick={afterGenerate}>
            <div className="scale-90 lg:scale-100 font-normal bg-white" onClick={(e) => e.stopPropagation()}>
                <div className="flex flex-col p-6 max-w-4xl mx-auto" ref={contentRef}>

                    <PdfHeader title="Pathology Test Report" id={details.id} date={report.date} />
...
const GenaratePathologyReport = ({ details, itemId, onPending }: PrintPathTestReportProps) => {
...
export default GenaratePathologyReport;
