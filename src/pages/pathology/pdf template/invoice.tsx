...
type Props = {
    afterGenerate: () => void,
    Info: PathologyBillDeatils
}


const GeneratePathologyInvoice = ({ afterGenerate, Info }: Props) => {
    ...
    const subTotal = Info.PathologyBillItems.reduce((acc, item) => acc + item.amount, 0)
                ...
                <div className="max-w-4xl mx-auto p-6 bg-white flex flex-col gap-y-5 border-b-2 border-dashed" ref={contentRef}>
                    ...
                    <div className="flex flex-col border border-gray-200 rounded-lg">
                        ...
                        <table className="min-w-full text-sm">
                            ...
                            <tbody>
                                {Info.PathologyBillItems?.map((item, i) => (
...
export default GeneratePathologyInvoice
