...
interface UnitFormProps extends HTMLAttributes<HTMLDivElement> {
...
const CreatePathologyUnit = ({ isPending, Submit, ...props }: UnitFormProps) => {

    const { register, handleSubmit, formState: { errors } } = useForm<z.infer<typeof PathUnitSchema>>({
        resolver: zodResolver(PathUnitSchema),
    })
...
export default CreatePathologyUnit