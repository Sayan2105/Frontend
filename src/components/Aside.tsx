...
import { Airplay, Ambulance, BriefcaseMedical, CalendarClock, ChevronRight, Droplets, HeartPulse, Loader, LogOut, Radiation, Settings, Stethoscope, TestTube, UserRound, Watch } from 'lucide-react'
...
const Aside = () => {
    ...
    return (
        <>
            ...
            {/* sidebar */}
            <aside className={cn('fixed h-[calc(100vh-65px)] sm:h-full sm:sticky w-56 p-2.5 transition-all duration-300 z-50 sm:z-auto border-r border-dashed bg-background border-zinc-200 dark:border-zinc-800', isSidebarOpen ? 'translate-x-0' : '-translate-x-full sm:translate-x-0')}
            >
